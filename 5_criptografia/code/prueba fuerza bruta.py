...
def descifrado_cesar_fuerza_bruta(cad_cif):
    # Entrada: La cadena original cifrada (criptograma)
    # Salida: Muestra todas las cadenas descifradas con claves posibles (de 1 a 27)

    # Variable auxiliar
    global abc  # La declaración global indica que la variable abc existe fuera de la función
    abc = list("abcdefghijklmnñopqrstuvwxyz")  # Lista con los elementos del abecedario español
